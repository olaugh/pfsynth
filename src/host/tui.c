...
enum {
    ...
    P_HMASS, P_HSTIFF, P_HEXP, P_VHARD, P_ATTACK, P_HVMAX, P_INJ, P_BODY, P_REVERB,
    P_MASTER, P_COUNT
};
...
static const pdesc PD[P_COUNT] = {
    ...
    [P_ATTACK]  = { "Attack bite",     0.0,    2.0,    0.05,   0, "%.2f", 1.0,    ""  },
