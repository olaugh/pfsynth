...
enum { OPT_TONE, OPT_ATTACK, OPT_PEDAL_MODE, OPT_UNA_CORDA, OPT_GAIN_DB, OPT_BODY_DB, OPT_KNOCK_DB, OPT_NOISE_DB, OPT_LIMITER,
       OPT_RESONANCE, OPT_RESONANCE_DB, OPT_RES_COUPLING, OPT_RES_SKIRT, OPT_RES_SUSTAIN, OPT_RES_TILT, OPT_RES_T60, OPT_COUNT };
static double get_opt(int id)
{
    ...
    case OPT_RES_COUPLING:return rp.coupling_db;case OPT_RES_SKIRT:return rp.skirt_hz;case OPT_RES_SUSTAIN:return rp.sustain_db;case OPT_RES_TILT:return rp.tilt_db;case OPT_RES_T60:return rp.t60_scale;
    }
    return 0;
}
...
void EXPORT(pfw_set)(int id,double v)
{
    ...
    case OPT_RES_TILT:rp.tilt_db=(float)v;res=1;break;case OPT_RES_T60:rp.t60_scale=(float)v;res=1;break;
    default:return;
    }
